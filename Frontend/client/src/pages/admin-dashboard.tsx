  ...
  const quickActions = [
    {
      ...
      description: "Manage sponsorships, volunteers, speakers & partners",
      icon: Gift,
      color: "from-orange-500 to-amber-500",
      bgGradient: "from-orange-50 to-amber-50",
      count: "5", // This is static, can be dynamic later
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-orange-50/20 to-amber-50/10">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Platform Summary */}
          <div className="space-y-4">
            {/* Platform Growth, System Status, Quick Links cards remain the same */}
